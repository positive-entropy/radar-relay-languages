{
//Italian Language Library, Incomplete
  'RATE' : ' Tasso ' //English: Rate
  'CHANGE' : ' Cambio ' //English: Change
  'BLOCK' : ' Blocco ' //English: Block
  'AMOUNT' : ' Quantità ' //English: Amount
  'PRICE' : ' Prezzo ' //English: Price
  'FEE' : ' Commissione ' //English: Fee
  'TIME' : ' Ora ' //English: Time
  'TOTAL' : ' Totale ' //English: Total
  'VOLUME' : ' Volume ' //English: Volume
  'WATCH' : ' Visualizza ' //English: Watch
  'UNWATCH' : ' Nascondi ' //English: Unwatch
  'NOTES' : ' Note ' //English: Notes
  'OK' : ' OK ' //English: Ok
  'FOR' : ' Per ' //English: For
  'CLOSE' : ' Chiuso ' //English: Close
  'BASE' : ' Base ' //English: Base
  'TRADE' : ' Trade ' //English: Trade
  'BUY' : ' Comprare ' //English: Buy
  'SELL' : ' Vendere ' //English: Sell
  'FILL' : ' Compilare ' //English: Fill
  'BUYING' : ' Compra ' //English: Buying
  'SELLING' : ' Vendi ' //English: Selling
  'TRADING' : ' Trading ' //English: Trading
  'EXPIRES' : ' Scade ' //English: Expires
  'ADDRESS' : ' Indirizzo ' //English: Address
  'ABBREVIATED_ADDRESS' : ' Ind. ' //English: Addr.
  'AVAILABLE' : ' Disponibile ' //English: Available
  'ORDERS' : ' Ordini ' //English: Orders
  'SPREAD' : ' Spread ' //English: Spread
  'POSITIONS' : ' Posizioni ' //English: Positions
  'MAX' : ' Max ' //English: Max
  'TO' : ' A ' //English: To
  'FROM' : ' Da ' //English: From
  'CANCEL' : ' Cancella ' //English: Cancel
  'CONTINUE' : ' Continua ' //English: Continue
  'FAILED' : ' Fallito ' //English: Failed
  'FINALIZED' : ' Concluso ' //English: Finalized
  'HOUR' : '  ' //English: Hour
  'DAY' : ' Giorno ' //English: Day
  'WEEK' : ' Settimana ' //English: Week
  'MONTH' : ' Mese ' //English: Month
  'FOREVER' : ' Per sempre ' //English: Forever
  'MARKET' : ' Mercato ' //English: Market
  'LIMIT' : ' Limite ' //English: Limit
  'STATUS' : ' Status ' //English: Status
  'FILLED' : ' Compilato ' //English: Filled
  'WRAP' : ' Trasforma in W-ETH ' //English: Wrap
  'UNWRAP' : ' Riporta in ETH ' //English: Unwrap
  'SEND' : ' Spedire ' //English: Send
  'ERROR' : ' Errore ' //English: Error
  'REFERENCE' : ' Riferimento ' //English: Reference
  'BOUGHT' : ' Comprato ' //English: Bought
  'SOLD' : ' Venduto ' //English: Sold
  ...
  'NO_FEE_NOVEMBER' : ' Niente commissioni a Novembre! ' //English: No Fee November!
  'LEARN_MORE' : ' Scopri di più ' //English: Learn More.
  'OPEN_RADAR' : ' Apri Radar ' //English: Open Radar
  'ABOUT' : ' Chi siamo ' //English: About
  'FAQ' : ' FAQ ' //English: FAQ
  'TERMS' : ' Termini ' //English: Terms
  'CONTACT' : ' Contatti ' //English: Contact
  'API' : ' API ' //English: API
  'PRICE_CHART' : ' Grafico dei prezzi ' //English: Price Chart
  'DEPTH_CHART' : '  ' //English: Depth Chart
  'TRADE_HISTORY' : ' Trade History ' //English: Trade History
  'N_TO_N_TRADING' : ' N:N Trading ' //English: N:N Trading
  'N_TO_N_ENABLE_TRADES' : '  ' //English: Enable N:N trades
  'N_TO_N_WARNING_HEADING' : ' N:N accoppiare token è un\'esperienza di trading unica. Alcune cose da tenere in mente mentre fai trading: ' //English: N:N token pairs are a unique trading experience. Some things to keep in mind as you trade:
  ...
  'N_TO_N_WARNING_PRICE' : ' Poiché i prezzi hanno token base che non sono stati visti prima, assicurati di verificare che il prezzo del tuo scambio sia quello che vuoi che sia. I prezzi delle valute di riferimento, sotto i campi input, possono assisterti in questa verifica. ' //English: Because prices have token bases that have not been seen before, make sure to verify that the price of your trade is what you want it to be. Reference currency prices below the input fields can assist in verification.
  'EXPERIMENTAL_FEATURE_DESC' : ' Questa è una funzione sperimentale e i lavori sono ancora in corso. Per favore usa questo strumento con cautela. ' //English: This is an experimental feature and a work in progress. Please use with caution.
  'NOT_RESPONSIBLE_WARNING' : '  ' //English: Radar Relay is not responsible for any loss of funds.
  'USING_RADAR_BETA' : ' Usare Radar Beta ' //English: Using Radar Beta
  'ETH_MUST_BE_WRAPPED' : ' Gli ETH nel tuo portafoglio devono essere trsformati in W-ETH prima di fare trading con i token ERC20. ' //English: ETH must be wrapped in wallet before trading for ERC20 tokens.
  'TOKENS_MUST_BE_ENABLED' : ' ERC20 richiede token abilitati nel portafoglio, prima di fare trading  ' //English: ERC20 requires enabling tokens in wallet before trading.
  'NO_ZRX_NEEDED_FOR_ZRX_BUY' : ' Non cè bisogno di ZRX per comprare ZRX, la commissione è presa dall\'ordine. ' //English: No ZRX is needed to buy ZRX, fee is taken from order.
  'ZRX_NEEDED_FOR_OTHER_BUY' : ' La commissione ZRX è necessaria per comprare tutti gli altri token. ' //English: ZRX fee is needed to buy all other tokens.
  'BETA_WARNING' : ' Per favore, considera che siamo ancora nella fase beta, potrebbero esserci potenziali bug e tassi non desiderati. Ti ringraziamo per la pazienza, mentre continuiamo a lavorare per il lancio della nostra versione ufficiale. ' //English: Please note that we are still in beta and potential bugs and undesirable rates may still exist. We thank you for your patience as we work towards our official version launch.
  ...
  'FILL_ORDER' : ' Compila l\'ordine ' //English: Fill Order
  'SUM_IN' : '  ' //English: Sum in
  'ORDER_PENDING' : ' L\'ordine è in sospeso! ' //English: Order is Pending!
  'ORDER_BROADCAST' : '  ' //English:  Your order has been broadcasted, you will receive a notification when it has been finalized.
  'VIEW_TRANSACTION' : ' Visualizza la transazione ' //English: View Transaction
  'ORDER_BOOK' : '  ' //English: Order Book
  'MID_MARKET_PRICE' : '  ' //English: Mid-Market Price
  'ORDER_DETAILS' : ' Dettagli ordine ' //English: Order Details
  'LAST_TRADE_PRICE' : ' ULTIMO PREZZO DI VENDITA ' //English: LAST TRADE PRICE
  'CLEAR_SELECTED_ORDER' : ' Cancella ordine selezionato ' //English: Clear Selected Order
  'MARKET_ORDER' : '  ' //English: Market Order
  'LIMIT_ORDER' : '  ' //English: Limit Order
  'SEND_TO' : ' Spedire a  ' //English: Send To
  'SUCCESSFULLY_SENT' : ' Inviato con successo ' //English: Successfully sent
  'OPEN_WALLET' : ' Portafoglio aperto ' //English: Open Wallet
  'CLOSE_WALLET' : ' Portafoglio chiuso ' //English: Close Wallet
  'TOTAL_HOLDINGS' : ' Proprietà totale ' //English: Total Holdings
  'INSTALL_METAMASK' : ' Installare MetaMask ' //English: Install MetaMask
  'YOUR_TOKENS' : '  ' //English: Tokens
  'YOUR_ORDERS' : ' Ordini ' //English: Orders
  'YOUR_HISTORY' : '  ' //English: History
  'ORDER_CANCELLED' : ' Il tuo ordine è stato cancellato! ' //English: Your order has been cancelled!
  ...
  'TOTAL_HOLDINGS_WALLET' : ' Proprietà totale ' //English: Total Holdings
  ...
  'NO_METAMASK_HEADER' : ' Metamask non installato ' //English: Metamask Not Installed
  ...
  'UNSUPPORTED_DEVICE_HEADER' : ' Device non supportato ' //English: Unsupported Device
  ...
  'INVALID_NETWORK_HEADER' : ' Network sbagliato ' //English: Wrong Network
  'INVALID_NETWORK_BODY' : ' Ti stai connettendo al network sbagliato. Passa a %s in Metamask per continuare ad utilizzare Radar. ' //English: You are connected to the wrong network. Switch to %s in Metamask to continue using Radar.
  'NO_NETWORK_HEADER' : ' Nessuna connessione di rete ' //English: No Network Connection
  ...
  'LOCKED_ACCOUNT_HEADER' : ' Account bloccato ' //English: Account Locked
  'LOCKED_ACCOUNT_BODY' : '  ' //English: Unlock your %s wallet to continue using Radar.
  'NO_ETH_HEADER' : ' No Ethereum ' //English: No Ethereum
  ...
  'NO_CONNECTION' : ' Nessuna connessione  ' //English: No Connection
  'NO_ACCOUNT_FOUND' : ' Account non trovato ' //English: No Account Found
  'INVALID_NETWORK' : '  ' //English: Please connect to the %s Network.
  'AMOUNT_GREATER_THAN_AVAILABLE' : ' L\'ammontare desiderato è maggiore dell'importo dell\'ordine disponibile ' //English: Desired amount is greater than available order amount.
  'VALIDATION_ERROR' : ' C\'è stato un campo malformato. Per favore riprova. ' //English: There was a malformed field. Please try again.
  'UNKNOWN_ERROR' : '  ' //English: Sorry, an unknown error has occurred.
  'DENIED_TRANSACTION_SIGNATURE' : ' Transazione cancellata. ' //English: Transaction canceled.
  'DENIED_MESSAGE_SIGNATURE' : ' Ordine cancellato ' //English: Order canceled.
  'MALFORMED_ORDER' : ' L\'ordine è stato compilato erroneamente. ' //English: Order was improperly formated.
  'ERROR_OBTAINING_TOKEN_BALANCE' : ' Impossibile ottenere il saldo dei tuoi token. Per favore riprova. ' //English: Unable to obtain your token balances. Please try again.
  'NO_MAKER_TOKEN_SELECTED' : ' Devi selezionare un token per la tua posizione. ' //English: You must select a token for your position.
  'NO_TAKER_TOKEN_SELECTED' : ' Devi selezionare il token che stai cercando. ' //English: You must select a token you are seeking.
  'INVALID_FEE_RECIPIENT_ADDRESS' : ' Indirizzo della commissione del relayer non valido ' //English: Invalid fee recipient address.
  'INVALID_MAKER_ADDRESS' : ' Indirizzo del maker non valido. ' //English: Invalid maker address.
  'MAKER_AMOUNT_ZERO' : ' L\'ammontare della vendita non può essere zero. ' //English: Sell amount cannot be zero.
  'TAKER_AMOUNT_ZERO' : ' L\'ammontare dell\'acquisto non può essere zero. ' //English: Buy amount cannot be zero.
  'SAVE_ORDER_ERROR' : ' Il server ha rifiutato l\'ordine, per favore riprova. ' //English: The server refused the order, please try again.
  'TAKER_IS_ORDER_MAKER' : ' Non puoi compilare il tuo stesso ordine. ' //English: You cannot fill your own order.
  'ORDER_NOT_FOUND' : '  ' //English: Order not found.
  'MIN_ORDER_SIZE_ERROR' : ' L\'ordine minimo deve essere maggiore di %s ' //English: Minimum order size must be greater than %s
  ...
  'ERROR_ENABLE_ZRX_MAKER_FEE' : ' Devi abilitare ZRX nel tuo portafoglio per pagare le maker fee quando questo ordine è compilato. ' //English: You must enable ZRX in your wallet to pay the maker fee when this order is filled.
  ...
  'ERROR_UNABLE_TO_PARSE_NUMBER' : ' Impossibile analizzare il numero ' //English: Unable to parse number
  'ERROR_INVALID_NUMBER' : ' Numero non valido ' //English: Invalid Number
  ...
  'TOKEN_WATCHLIST_FULL' : ' La Token Watchlist è piena ' //English: The Token Watchlist is full.
  'WATCHLIST_ADD_PAIRS' : '  ' //English: Add Pairs to Watchlist
  'MAKER_TOKEN_ALLOWANCE_NOT_ENABLED' : ' Devi permettere %s per poter fare trading ' //English: You must allow %s in order to trade with it.
  'TAKER_TOKEN_ALLOWANCE_NOT_ENABLED' : ' Devi permettere %s per poter fare trading ' //English: You must allow %s in order to trade with it.
  'INSUFFICIENT_ZRX_FOR_FEE' : ' Non ci sono abbastanza ZRX per coprire la commissione dell\'ordine. ' //English: There is not enough ZRX to cover the order fee.
  'INSUFFICIENT_TOKEN_AMOUNT' : ' Non c\'è abbastanza %s per  eseguire questo ordine. ' //English: There is not enough %s to fulfill this order.
  'AMOUNT_EXCEEDS_BOOK' : ' Il quantitativo supera l\'orderbook ' //English: Amount exceeds book
  'AMOUNT_RATIO_INEXACT' : ' Arrotondare per precisione ' //English: Rounded for precision
  ...
  'INSUFFICIENT_MAKER_ALLOWANCE' : ' L\'account che ha creato quest\'ordine ha disabilitato questo token. ' //English: The account that created this order has disabled this token.
  'INSUFFICIENT_MAKER_BALANCE' : ' L\'account che ha creato quest\'ordine non ha più token sufficienti. ' //English: The account that created this order no longer has enough tokens.
  'INSUFFICIENT_MAKER_FEE_ALLOWANCE' : ' L\'account che ha creato quest\'ordine ha disabilitato ZRX e non può più pagare la commissione. ' //English: The account that created this order has disabled ZRX and can longer pay the fee.
  'INSUFFICIENT_MAKER_FEE_BALANCE' : ' L\'account che ha creato quest\'ordine non ha sufficiente ZRX per coprire la commissione dell\'ordine. ' //English: The account that created this order does not have enough ZRX to cover the order fee.
  'INSUFFICIENT_TAKER_ALLOWANCE' : ' Hai bisogno di abilitare questo token. Attiva il pulsante nel tuo portafoglio. ' //English: You need to enable this token. Activate the toggle in your wallet.
  'INSUFFICIENT_TAKER_BALANCE' : '  ' //English: You don\'t have enough in your wallet to complete this order.
  'INSUFFICIENT_TAKER_FEE_ALLOWANCE' : ' ZRX deve essere abilitato per processare le commissioni della transazione. Abilita il pulsante nel tuo portafoglio. ' //English: ZRX must be enabled to process transaction fees. Enable the toggle in your wallet.
  'INSUFFICIENT_TAKER_FEE_BALANCE' : '  ' //English: You don\'t have enough in your wallet to cover transaction fees.
  'INSUFFICIENT_REMAINING_FILL_AMOUNT' : ' L\'importo che stai cercando di inserire è più di quanto rimane nell\'ordine. ' //English: Amount you are trying to fill is more than what remains in the order.
